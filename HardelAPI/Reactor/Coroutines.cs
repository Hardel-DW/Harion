 ...
 * https://github.com/NuclearPowered/Reactor/blob/master/Reactor/Coroutines.cs
 * 
 * Discord :
...
namespace HardelAPI.Reactor {
    ...
    public static class Coroutines {
        ...
        private static void ProcessCoroutineList(List<IEnumerator> target) {
            ...
            target.Clear();
            foreach (var enumerator in _tempList)
        ...
        private static void ProcessNextOfCoroutine(IEnumerator enumerator) {
            try {
                ...
                HardelApiPlugin.Logger.LogError(e.ToString());
            ...
            switch (next) {
                ...
                case Il2CppObjectBase il2CppObjectBase:
                    ...
                    if (nextAsEnumerator != null) // il2cpp IEnumerator also handles CustomYieldInstruction
                        ...
                        HardelApiPlugin.Logger.LogWarning($"Unknown coroutine yield object of type {il2CppObjectBase} for coroutine {enumerator}");
                    break;
            }
