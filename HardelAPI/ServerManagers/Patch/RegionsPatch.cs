...
namespace HardelAPI.ServerManagers.Patch {
    public static class RegionsPatch {
        ...
        internal static IRegionInfo[] NewRegions { get; } = new IRegionInfo[] {
            new DnsRegionInfo("192.241.154.115", "skeld.net", StringNames.NoTranslation, "192.241.154.115", 22023).Cast<IRegionInfo>(),
            new DnsRegionInfo("localhost", "localhost", StringNames.NoTranslation, "127.0.0.1", 22023).Cast<IRegionInfo>(),
            new DnsRegionInfo("152.228.160.91", "matux.fr", StringNames.NoTranslation, "152.228.160.91", 22023).Cast<IRegionInfo>(),
            new DnsRegionInfo("77.55.217.159", "Przebot", StringNames.NoTranslation, "77.55.217.159", 22023).Cast<IRegionInfo>()
        };
        ...
        public static void Patch() {
            ...
            IRegionInfo[] patchedRegions = OldRegions.AddRangeToArray(NewRegions).AddRangeToArray(ModRegions.ToArray());
            
            if (DirectRegion != null)
                patchedRegions = patchedRegions.AddToArray(DirectRegion);
        ...
        private static void UpdateRegion() {
            ...
            bool success = CustomRegion.SetDirectRegion(DirectConnect.text, out IRegionInfo newRegion);
        ...
        public static class RegionMenuPatches {
            ...
            internal static void RefreshRegionMenu() {
                ...
                var showOfficials = HardelApiPlugin.ShowOfficialRegions.Value;
                var showExtras = HardelApiPlugin.ShowExtraRegions.Value;
    ...
    internal static class RegionsEditor {
        ...
        private static async Task SetUpToggleOfficialsButton() {
            ...
            _toggleOfficialsButton.OnClick.AddListener((Action) (() => {
                HardelApiPlugin.ShowOfficialRegions.Value = !HardelApiPlugin.ShowOfficialRegions.Value;
                RegionsPatch.RegionMenuPatches.RefreshRegionMenu();
            }));
        }
        ...
        private static async Task SetUpToggleExtrasButton() {
            ...
            _toggleExtrasButton.OnClick.AddListener((Action) (() => {
                HardelApiPlugin.ShowExtraRegions.Value = !HardelApiPlugin.ShowExtraRegions.Value;
                RegionsPatch.RegionMenuPatches.RefreshRegionMenu();
            }));
        }
