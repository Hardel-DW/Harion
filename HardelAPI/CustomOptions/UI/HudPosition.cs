using HardelAPI.CustomOptions.Event;
using System;
using UnityEngine;

namespace HardelAPI.CustomOptions.UI {
    public class HudPosition {
        ...
        private static void HudUpdated(object sender, EventArgs e) {
            ...
            if (PixelWidth == Camera.main.pixelWidth && PixelHeight == Camera.main.pixelHeight)
                return;
            ...
            if (oldPixelWidth != 0 && oldPixelHeight != 0)
                Events.RaiseResolutionChanged(oldPixelWidth, oldPixelHeight, oldWidth, oldHeight);
        }
