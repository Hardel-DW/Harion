...
namespace HardelAPI.Cooldown {
    ...
    public abstract class CooldownButton {
        ...
        internal void CreateButton(HudManager Instance) {
            ...
            if (gameObject == null)
                HardelApiPlugin.Logger.LogError($"CooldownButton in MainMenuStart does not exist !");
        ...
        public void SetText(string text) {
            if (TextMeshPro != null)
                ...
                HardelApiPlugin.Logger.LogError("TextMeshPro is not defined for this CooldownButton !");
        }
