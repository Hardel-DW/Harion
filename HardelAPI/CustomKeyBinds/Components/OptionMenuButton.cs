    ...
    public class OptionsMenuButton {
        ...
        private void Start(OptionsMenuBehaviour optionsMenu, GameObject parent) {
            ...
            if (backgroundComponent == null)
                HardelApiPlugin.Logger.LogError($"backgroundComponent in OptionsMenuButton does not exist !");


            if (textComponent == null)
                HardelApiPlugin.Logger.LogError($"textComponent in OptionsMenuButton does not exist !");
