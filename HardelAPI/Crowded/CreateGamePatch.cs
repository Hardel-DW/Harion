    ...
    internal static class CreateGameOptionsPatches {
        ...
        public static class CreateOptionsPicker_Start
        {
            ...
            public static void Postfix(CreateOptionsPicker __instance) {
                ...
                List<SpriteRenderer> playerButtons = __instance.MaxPlayerButtons.ToArray().ToList();
                ...
                PassiveButton passiveButton = plusButton.GetComponent<PassiveButton>();
                ...
                Il2CppSystem.Collections.Generic.List<SpriteRenderer> NewArray = new Il2CppSystem.Collections.Generic.List<SpriteRenderer>();
                playerButtons.ForEach(b => NewArray.Add(b));

                __instance.MaxPlayerButtons = NewArray;
