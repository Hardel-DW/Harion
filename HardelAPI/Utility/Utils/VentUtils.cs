...
namespace HardelAPI.Utility.Utils {
    ...
    public static class VentUtils {
		...
		public static void RpcSealMultipleVent(List<Vent> vents) {
			HardelApiPlugin.Logger.LogInfo($"ventIds: {vents.Count}");
		...
		public static void SealVent(Vent vent) {
			...
			HardelApiPlugin.Logger.LogInfo($"Seal vent:  {vent.Id}");

			Sprite staticSealdedVent = SpriteHelper.LoadSpriteFromEmbeddedResources("HardelAPI.Resources.StaticVentSealed.png", 150f);
			Sprite animatedSealeddVent = SpriteHelper.LoadSpriteFromEmbeddedResources("HardelAPI.Resources.AnimatedVentSealed.png", 150f);
