    ...
    internal partial class ModsInformation {
        ...
        internal ModsInformation(MainMenuManager instance, GameObject Parent) {
            ...
            if (closeRenderer != null)
                closeRenderer.sprite = SpriteHelper.LoadSpriteFromEmbeddedResources("Harion.Resources.Back.png", 100f);
        ...
        private void UpdateScroll() {
            if (Instance.SocialBackground == null) {
                HarionPlugin.Logger.LogError($"An error occurred while updating the YBounds of the ModsInformation.SocialBackground Scroll. The GameObject SocialBackground, of the ModsInformation class is not defined or at the wrong time.");
                return;
            }
        ...
        public async Task<bool> DownloadUpdate(VersionUpdate VersionInfo) {
            ...
            HarionPlugin.Logger.LogError("Update wasn't successful\nTry again later,\nor update manually.");
            return false;
        }
