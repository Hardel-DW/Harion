...
namespace Harion.ModsManagers.Mods {
    public class ModsSocial {
        ...
        // Social Sprite
        public static Sprite YoutubeSprite => SpriteHelper.LoadSpriteFromEmbeddedResources("Harion.Resources.Social.Youtube.png", 100f).DontDestroy();
        public static Sprite TwitchSprite => SpriteHelper.LoadSpriteFromEmbeddedResources("Harion.Resources.Social.Twitch.png", 100f).DontDestroy();
        public static Sprite PatreonSprite => SpriteHelper.LoadSpriteFromEmbeddedResources("Harion.Resources.Social.Patreon.png", 100f).DontDestroy();
        public static Sprite PaypalSprite => SpriteHelper.LoadSpriteFromEmbeddedResources("Harion.Resources.Social.Paypal.png", 100f).DontDestroy();
        public static Sprite DiscordSprite => SpriteHelper.LoadSpriteFromEmbeddedResources("Harion.Resources.Social.Discord.png", 100f).DontDestroy();
        public static Sprite GithubSprite => SpriteHelper.LoadSpriteFromEmbeddedResources("Harion.Resources.Social.Github.png", 100f).DontDestroy();
