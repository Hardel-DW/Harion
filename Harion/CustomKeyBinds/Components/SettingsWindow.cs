...
namespace Harion.CustomKeyBinds.Components {
    public class SettingsWindow : PopUpWindow {
        public static Sprite NavigationArrow = SpriteHelper.LoadSpriteFromEmbeddedResources("Harion.Resources.Navigation.png", 100f).DontDestroy();
        ...
        private void Start(OptionsMenuBehaviour optionsMenu) {
            ...
            if (holder.transform.Find("CloseButton(Clone)") != null) {
                ...
                if (renderer != null)
                    renderer.sprite = SpriteHelper.LoadSpriteFromEmbeddedResources("Harion.Resources.Back.png", 100f);
            }
        }
