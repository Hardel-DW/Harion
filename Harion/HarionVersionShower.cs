    ...
    public static class HarionVersionShower {
        ...
        internal static void Initialize() {
            SceneManager.add_sceneLoaded((Action<Scene, LoadSceneMode>) ((_, _) => {
                ...
                GameObject gameObject = new GameObject("Harion Version " + Guid.NewGuid());
                gameObject.transform.parent = original.transform.parent;

                AspectPosition aspectPosition = gameObject.AddComponent<AspectPosition>();

                aspectPosition.Alignment = AspectPosition.EdgeAlignments.LeftTop;

                AspectPosition originalAspectPosition = original.GetComponent<AspectPosition>();
                Vector3 originalPosition = originalAspectPosition.DistanceFromEdge;
        ...
        public static void UpdateText() {
            Text.text = "Harion " + typeof(HarionPlugin).Assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>().InformationalVersion;
